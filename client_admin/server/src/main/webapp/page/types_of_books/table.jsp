...
<div class="section1">
    ...
    <div class="table">
        <table class="layui-hide" id="types_of_books" lay-filter="types_of_books"></table>
...
<script src="../../js/axios.min.js"></script>
    ...
    layui.use(['element', 'layer', 'util'], function () {
        ...
        let url = BaseUrl + '/api/types_of_books/get_list?like=0'
        ...
        if (user_group == "管理员" || $check_action('/types_of_books/table', 'del') || $check_action('/types_of_books/view', 'del')) {
            deletes.style.display = "block"
        }
        if (user_group == "管理员" || $check_action('/types_of_books/table', 'add') || $check_action('/types_of_books/view', 'add')) {
            add.style.display = "block"
        }
        if (user_group == "管理员" || $check_action('/types_of_books/view', 'get') || $check_action('/types_of_books/view', 'set')) {
            detail_flag = true;
        }
 ...
 function open_tip(arr) {
    ...
    ,
        ...
        open_tip(res.result.list);
            ...
            if (user_group == "管理员" || $check_pay('/types_of_books/table')) {
                for (var i = 0; i < res.result.list.length; i++) {
                    res.result.list[i].check_pay = true
                }
            }
            if (user_group == "管理员" || $check_action('/types_of_books/view', 'set') || $check_action('/types_of_books/view', 'get')) {
                for (var i = 0; i < res.result.list.length; i++) {
    ...
    ,
        ...
        table.on('tool(types_of_books)', function (obj) {
            var data = obj.data;
        if (obj.event === 'detail')
        {

                            window.location.href = "./view_add.jsp?" + data.types_of_books_id;
                    }
        ...
        let resetSelect = []
        //下拉框重置/Reset参数
        fun('types_of_books', BaseUrl + '/api/types_of_books/del', 'types_of_books_id', request, resetName, resetSelect        )
