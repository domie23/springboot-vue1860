                ...
                <li class="layui-nav-item" id="userManagement" style="display: none;">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="./user/table.jsp" target="main_self_frame" id="user">管理员</a></dd>
                                                                                    <dd style="display: none" id="ordinary_manager">
                                    <a href="./ordinary_manager/table.jsp" target="main_self_frame">普通管理者</a>
                                </dd>
                                                                                                                                                                                                                                    </dl>
                </li>
...
<script>
    ...
    console.log(personInfo)
        ...
        if(user_group == '管理员' || $check_group(['/user/table','/user_group/table','/auth/table'                            ,'/ordinary_manager/table'
                                                                                        ])){
            userManagement.style.display = 'block'
        }
        if(user_group !== '管理员'){
            user.style.display = "none"
                                    ...
                                    let ordinary_manager = document.querySelector('#ordinary_manager')
                if(user_group == '管理员' || $check_action('/ordinary_manager/table')){
                        ordinary_manager.style.display = "block"
                }else {
                        ordinary_manager.style.display = "none"
                }
